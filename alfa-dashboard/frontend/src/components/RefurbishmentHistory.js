                  ...
                  <tr key={r._id} style={{ borderBottom: "1px solid #f3f4f6" }}>
                    ...
                    <td style={{ padding: 10 }}>
                      <div style={{ fontWeight: 700 }}>
                        {r.car ? `${r.car.make} ${r.car.model}` : "Unknown"}
                      </div>
                    </td>
                    <td style={{ padding: 10 }}>
                      {r.items &&
          ...
          >
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              <div>
                <h3 style={{ margin: 0 }}>
                  {selected.car
                    ? `${selected.car.make} ${selected.car.model}`
                    : "Unknown"}
                </h3>
                <div style={{ color: "#6b7280" }}>
            ...
            <div style={{ marginTop: 8 }}>
              {selected.items.map((it, i) => (
                ...
                >
                  ...
                  <div>
                    ₹{(it.amount || it.quantity * it.rate).toLocaleString()}
                  </div>
                </div>
              ))}
              <div style={{ marginTop: 8, fontWeight: 700 }}>
                Total: ₹{(selected.totalCost || 0).toLocaleString()}
              </div>
            </div>
          </div>
        )}
