  ...
  function setPreferred(lang) {
    try {
      ...
      if (typeof window.translatePage === "function")
        window.translatePage(lang || getPreferred());
    } catch (e) {}
  }
  ...
  const translations = {
    ka: {
      ...
      "Spacious and powerful for all terrains":
        "ಎಲ್ಲಾ ಭೂಗೋಳಗಳಿಗೆ ಪ್ರಸಾರಶೀಲ ಮತ್ತು ಶಕ್ತಿಶಾಲಿ",
      "Sporty 2-door car for stylish drives":
        "ಶೈಲಿಯ conducir ಗೆ ಸ್ಪೋರ್ಟಿ 2-ಡೋರ್ ಕಾರು",
      "Roof can be folded, great for open-air drives":
        "ಛಾವಣಿಯನ್ನು ಮಡಚಬಹುದು, ತೆರೆದ ಪ್ರೇರಿತ ಚಾಲನೆಗಳಿಗೆ ಉತ್ತಮ",
      "Multi-Utility Vehicle, ideal for families/groups":
        "ಬಹು-ಉಪಯೋಗಿ ವಾಹನ, ಕುಟುಂಬ/ಗುಂಪುಗಳಿಗೆ ಬಲವಾದವರು",
      "High-end premium segment vehicles":
        "ಉನ್ನತ- ಮಟ್ಟದ ಪ್ರೀಮಿಯಂ ವಿಭಾಗದ ವಾಹನಗಳು",
      ...
      "Get the best price for your Car with our free valuation and quick payment.":
        "ನಮ್ಮ ಉಚಿತ ಮೌಲ್ಯಮಾಪನ ಮತ್ತು_quick ಪಾವತಿಯೊಂದಿಗೆ ನಿಮ್ಮ ಕಾರಿಗೆ ಉತ್ತಮ ಬೆಲೆಯನ್ನು ಪಡೆಯಿರಿ.",
      "Professional servicing and maintenance by certified technicians.":
        "ಪ್ರಮಾಣಿತ ತಂತ್ರಜ್ಞರಿಂದ ವೃತ್ತಿಪರ ಸೇವೆ ಮತ್ತು ನಿರ್ವಹಣೆ.",
      ...
      "Search our certified inventory and filter by brand, year, price and more to find the perfect Car.":
        "ನಮ್ಮ ಪ್ರಮಾಣಿತ ಇನ್‌ವೆಂಟರಿಯನ್ನು ಹುಡುಕಿ ಮತ್ತು ಪರಿಪೂರ್ಣ ಕಾರು ಕಂಡುಹಿಡಿಯಲು ಬ್ರ್ಯಾಂಡ್, ವರ್ಷ, ಬೆಲೆ ಮತ್ತು ಇತರ ತಾಣಗಳಿಂದ ಫಿಲ್ಟರ್ ಮಾಡಿ.",
      "Check vehicle history, inspection report and ask questions to the seller before buying.":
        "ವಾಹನದ ಇತಿಹಾಸ, ಪರಿಶೀಲನಾ ವರದಿ ಪರಿಶೀಲಿಸಿ ಮತ್ತು ಖರೀದಿಸುವ ಮೊದಲು ಮಾರಾಟಗಾರನಿಗೆ ಪ್ರಶ್ನೆಗಳನ್ನು ಕೇಳಿ.",
      "Reserve the Car online or visit our showroom for a test drive and final checks.":
        "ಉಪಕರಣವನ್ನು ಆನ್‌ಲೈನ್‌ನಲ್ಲಿ ಮೀಸಲಿಡಿ ಅಥವಾ ಟೆಸ್ಟ್ ಡ್ರೈವ್ ಮತ್ತು ಅಂತಿಮ ಪರಿಶೀಲನೆಗಾಗಿ ನಮ್ಮ ಶೋರೂಮನ್ನು ಭೇಟಿ ಮಾಡಿ.",
      ...
      "Schedule a professional evaluation to accurately assess your car's condition and market value.":
        "ನಿಮ್ಮ ಕಾರಿನ ಸ್ಥಿತಿ ಮತ್ತು ಮಾರುಕಟ್ಟೆ ಮೌಲ್ಯವನ್ನು ನಿಖರವಾಗಿ ಅಂದಾಜು ಮಾಡಲು ವೃತ್ತಿಪರ ಮೌಲ್ಯಮಾಪನವನ್ನು ನಿಯೋಜಿಸಿ.",
      "Clean and detail your car thoroughly, addressing any minor repairs or cosmetic":
        "ಏತಾದರೂ ಸಣ್ಣ ದುರಸ್ತಿ ಅಥವಾ ಹೊರಗಿನ ಸೌಂದರ್ಯ ಸಮಸ್ಯೆಗಳನ್ನು ಸರಿ ಮಾಡುವುದು ಮತ್ತು ನಿಮ್ಮ ಕಾರನ್ನು ಪೂರ್ಣವಾಗಿ ಶುಚಿಗೊಳಿಸಿ.",
      "Take high-quality photos and write a detailed, honest description highlighting":
        "ಹೆಚ್ಚು ಗುಣಮಟ್ಟದ ಫೋಟೊಗಳನ್ನು ತೆಗೆದುಕೊಳ್ಳಿ ಮತ್ತು ವಿವರವಾದ, ನೈಜ ವಿವರಣೆಯನ್ನು ಬರೆಯಿರಿ.",
      ...
      "We make selling your Car simple, fast, and transparent. Get an instant quote and complete the process in just a few clicks.":
        "ನಾವು ನಿಮ್ಮ ಕಾರ್ ಮಾರಾಟವನ್ನು ಸರಳ, ವೇಗವಾಗಿ ಮತ್ತು ಪಾರದರ್ಶಕವಾಗಿಸುವೆವು. ತಕ್ಷಣದ ಕೊಟ್ ಪಡೆಯಿರಿ ಮತ್ತು ಕೆಲವು ಕ್ಲಿಕ್‌ನಲ್ಲಿ ಪ್ರಕ್ರಿಯೆ ಪೂರ್ಣಗೊಳಿಸಿ.",
      "Enter Your Car Details": "ನಿಮ್ಮ ಕಾರಿನ ವಿವರಗಳನ್ನು ನಮೂದಿಸಿ",
      "Fill out the form with your Car's specifications and condition.":
        "ನಿಮ್ಮ ಕಾರಿನ ವೈಶಿಷ್ಟ್ಯಗಳು ಮತ್ತು ಸ್ಥಿತಿಯನ್ನು ಫಾರ್ಮ್‌ನಲ್ಲಿ ಭರ್ತಿ ಮಾಡಿ.",
      "Schedule Pickup & Get Paid":
        "ಪಿಕಪ್ ಅನ್ನು ಶೆಡ್ಯೂಲ್ ಮಾಡಿ ಮತ್ತು ಪಾವತಿ ಪಡೆಯಿರಿ",
      "We handle all the paperwork and payment on the spot.":
        "ನಾವು ಎಲ್ಲಾ ಕಾಗದಪತ್ರಗಳನ್ನು ಮತ್ತು ಪಾವತಿಯನ್ನು ತಕ್ಷಣ ನಿರ್ವಹಿಸುತ್ತೇವೆ.",
      ...
      "&copy; 2023 Alfa Motors World. All rights reserved.":
        "© 2023 ಅಲ್ಫಾ ಮೋಟಾರ್ಸ್ ವರ್ಲ್ಡ್. ಎಲ್ಲಾ ಹಕ್ಕುಗಳು ಸಂರಕ್ಷಿಸಲಾಗಿದೆ.",
      ...
      "Monday - Saturday: 9:00 AM - 8:00 PM<br />Sunday: 10:00 AM - 4:00 PM":
        "ಸೋಮವಾರ - ಶನಿವಾರ: ಬೆಳಿಗ್ಗೆ 9:00 - ಸಂಜೆ 8:00<br />ಭಾನುವಾರ: ಬೆಳಿಗ್ಗೆ 10:00 - ಮಧ್ಯಾಹ್ನ 4:00",
      ...
      "From humble beginnings to trusted dealership":
        "ಸರಳ ಆರಂಭದಿಂದ ವಿಶ್ವಾಸಾರ್ಹ ಡೀಲرشಿಪ್ ಆಗಿ ಬೆಳೆಯುವ ತನಕ",
      "Humble Beginnings": "ಸರಳ ಆರಂಭ",
      "Started as a small Car repair shop in Muzaffarpur with just 2 employees":
        "ಮುಜಫರ್ಗರ್ಪುರ್‌ನಲ್ಲಿ ಕೇವಲ 2 ಉದ್ಯೋಗಿಗಳೊಂದಿಗೆ ಸಣ್ಣ ಕಾರು ದುರಸ್ತಿ ಅಂಗಡಿಯಾಗಿ ಪ್ರಾರಂಭಿಸಲಾಯಿತು",
      "First Showroom": "ಮೊದಲ ಶೋರೂಮ್",
      "Opened our first dedicated showroom at Kanhauli Naka":
        "ಕನ್ಹೊಳಿ ನಕಾ ನಲ್ಲಿ ನಮ್ಮ ಮೊದಲ ಶೋರೂಮ್ ಉದ್ಘಾಟಿಸಲಾಯಿತು",
      "Launched our online platform and expanded to neighboring cities":
        "ನಮ್ಮ ಆನ್‌ಲೈನ್ ಪ್ಲಾಟ್‌ಫಾರ್ಮ್ ಅನ್ನು ಪ್ರಾರಂಭಿಸಿ ಸಮೀಪದ ನಗರಗಳಿಗೆ ವಿಸ್ತರಿಸಲಾಗಿದೆ",
      "Premium Collection": "ಪ್ರೀಮಿಯಂ ಸಂಗ್ರಹ",
      "Introduced our premium segment with high-end Cars":
        "ಹೈ-ಎಂಡ್ ಕಾರುಗಳೊಂದಿಗೆ ನಮ್ಮ ಪ್ರೀಮಿಯಂ ವಿಭಾಗವನ್ನು ಪರಿಚಯಿಸಿದೇವೆ",
      "New Facility": "ಹೊಸ ಸೌಲಭ್ಯ",
      "Moved to our new 10,000 sq ft facility with state-of-the-art service center":
        "ಅತ್ಯಾಧುನಿಕ ಸೇವಾ ಕೇಂದ್ರವಿರುವ 10,000 ಚದರಅಡಿ ಹೊಸ ಸೌಲಭ್ಯಕ್ಕೆ ಸ್ಥಳಾಂತರಗೊಂಡಿದೆ",
      "Our Core Values": "ನಮ್ಮ ಮುಖ್ಯ ಮೌಲ್ಯಗಳು",
      "The principles that guide everything we do":
        "ನಾವು ಮಾಡುವ ಪ್ರತಿಯೊಂದು ಕೆಲಸವನ್ನು ಮಾರ್ಗದರ್ಶನ ಮಾಡುವ ತತ್ವಗಳು",
      "We believe in complete transparency and honesty in all our dealings. No hidden costs, no surprises.":
        "ನಮ್ಮ ಎಲ್ಲಾ ವ್ಯವಹಾರಗಳಲ್ಲಿ ಸಂಪೂರ್ಣ ಪಾರದರ್ಶಕತೆ ಮತ್ತು ನೈತಿಕತೆಯನ್ನು ನಾವು ನಂಬುತ್ತೇವೆ. ಗೂಪ್ತ ವೆಚ್ಚಗಳಿಲ್ಲ, ಅಚ್ಚರಿಗಳಿಲ್ಲ.",
      "Every car undergoes a 150-point inspection to ensure it meets our high standards before being listed.":
        "ಪ್ರತಿ ಕಾರು ನಮೂದಿಸmeden ಮೊದಲು ನಮ್ಮ ಉನ್ನತ ಮಾನದಂಡಗಳನ್ನು ಪೂರೈಸುವಂತೆ 150-ದ್ದು ಪರೀಕ್ಷೆಯನ್ನು ಅನುಭವಿಸುತ್ತದೆ.",
      "We're car enthusiasts first, business people second. Our love for cars drives everything we do.":
        "ನಾವು ಮೊದಲು ಕಾರು սիրುಗಾರರು, ನಂತರ ವ್ಯಾಪಾರಸ್ಥರು. ಕಾರುಗಳಿಗೂ ನಮ್ಮ ಪ್ರೀತಿ ನಮ್ಮ ಎಲ್ಲಾ ಕೆಲಸಗಳನ್ನೇ ಪ್ರೇರೇಪಿಸುತ್ತದೆ.",
      "From first contact to after-sales, we provide exceptional service that keeps customers coming back.":
      ...
      "Monday - Saturday: 9:00 AM - 8:00 PM<br />Sunday: 10:00 AM - 4:00 PM":
        "ಸೋಮವಾರ - ಶನಿವಾರ: ಬೆಳಗ್ಗೆ 9:00 - ಸಂಜೆ 8:00<br />ಭಾನುವಾರ: ಬೆಳಗ್ಗೆ 10:00 - ಮಧ್ಯಾಹ್ನ 4:00",
      "Current Status": "ಪ್ರಸ್ತುತ ಸ್ಥಿತಿ",
      "Social Media": "ಸಾಮಾಜಿಕ ಮಾಧ್ಯಮ",
      "Connect with us on social platforms":
        "ಸಾಮಾಜಿಕ ವೇದಿಕೆಗಳಲ್ಲಿ ನಮ್ಮೊಂದಿಗೆ ಸಂಪರ್ಕಿಸಿ",
      ...
      "Provide details about the Car you're interested in and your budget.":
        "ನೀವು ಆಸಕ್ತರಾಗಿರುವ ಕಾರಿನ ವಿವರಗಳು ಮತ್ತು ನಿಮ್ಮ ಬಜೆಟ್ ಅನ್ನು ನೀಡಿ.",
      "Get Expert Recommendations": "ತಜ್ಞರ ಶಿಫಾರಸುಗಳನ್ನು ಪಡೆಯಿರಿ",
      "Our team will analyze your requirements and find the best matches.":
        "ನಮ್ಮ ತಂಡ ನಿಮ್ಮ ಅಗತ್ಯಗಳನ್ನು ವಿಶ್ಲೇಷಿಸಿ ಅತ್ಯುತ್ತಮ ಹೊಂದಾಣಿಕೆಗಳನ್ನು ಕಂಡುಹಿಡಿಯಲಿದೆ.",
      "Receive Your Quote": "ನಿಮ್ಮ ಕೊಟ್ ಸ್ವೀಕರಿಸಿ",
      "We'll contact you with detailed options and pricing information.":
        "ವಿವರವಾದ ಆಯ್ಕೆಗಳು ಮತ್ತು ಬೆಲೆ ಮಾಹಿತಿಯೊಂದಿಗೆ ನಾವು ನಿಮ್ಮನ್ನು ಸಂಪರ್ಕಿಸೋಣ.",
      ...
      "© 2023 Alfa Motors World. All rights reserved.":
        "© 2023 ಅಲ್ಫಾ ಮೋಟಾರ್ಸ್ ವರ್ಲ್ಡ್. ಎಲ್ಲಾ ಹಕ್ಕುಗಳು ಸಂರಕ್ಷಿಸಲಾಗಿದೆ.",
    },
  };
        ...
        if (page === "https://www.alfamotorworld.com/finance.html") {
          ...
          function setAlt(img, alt) {
            ...
            if (!img.dataset.origAlt)
              img.dataset.origAlt = img.getAttribute("alt") || "";
          ...
          if (lang === "ka") {
            ...
            setText(
              ".finance-hero p",
              "ನಾವು ವಿಶ್ವಾಸಾರ್ಹ ಬ್ಯಾಂಕುಗಳು ಮತ್ತು NBFCಗಳೊಂದಿಗೆ ಕೆಲಸಮಾಡಿ, ಬೆಂಗಳೂರು ಮತ್ತು ಕರ್ನಾಟಕದಲ್ಲಿ ಪೂರ್ವ-ಮಾಲೀಕ ಕಾರುಗಳಿಗಾಗಿ ವೇಗವಾದ ಅನುಮತಿ, ಸ್ಪರ್ಧಾತ್ಮಕ EMI ಮತ್ತು ಕನಿಷ್ಠ ದಾಖಲೆಕಾರ್ಯವನ್ನು ಒದಗಿಸುತ್ತೇವೆ.",
            );
            ...
            for (let i = 1; i <= 5; i++) {
              ...
              const desc =
                strong && strong.parentElement
                  ? strong.parentElement.querySelector("div")
                  : null;
              if (i === 1) {
                if (strong) {
                  if (!strong.dataset.origText)
                    strong.dataset.origText = strong.textContent;
                  strong.textContent = "ವಾಹನನ್ನು ಆರಿಸಿ";
                }
                if (desc) {
                  if (!desc.dataset.origText)
                    desc.dataset.origText = desc.textContent;
                  desc.textContent =
                    "ನಿಮ್ಮ ಇಚ್ಛಿತ ಪೂರ್ವ-ಮಾಲೀಕ ಕಾರನ್ನು ನಮ್ಮ ಇನ್‌ವೆಂಟರಿಯಿಂದ ಆಯ್ಕೆಮಾಡಿ.";
                }
              }
              if (i === 2) {
                if (strong) {
                  if (!strong.dataset.origText)
                    strong.dataset.origText = strong.textContent;
                  strong.textContent = "ಕೊಟ್ ಪಡೆಯಿರಿ";
                }
                if (desc) {
                  if (!desc.dataset.origText)
                    desc.dataset.origText = desc.textContent;
                  desc.textContent =
                    "ಕೊಟ್ ಟೂಲನ್ನು ಬಳಸಿ ಅಥವಾ ಇನ್ವಾಯ್ಸ್ ಮತ್ತು ಸಾಲದ ಅಂದಾಜಿಗಾಗಿ ನಮ್ಮನ್ನು ಸಂಪರ್ಕಿಸಿ.";
                }
              }
              if (i === 3) {
                if (strong) {
                  if (!strong.dataset.origText)
                    strong.dataset.origText = strong.textContent;
                  strong.textContent = "ದಾಖಲೆಗಳನ್ನು ಅಪ್ಲೋಡ್ ಮಾಡಿ";
                }
                if (desc) {
                  if (!desc.dataset.origText)
                    desc.dataset.origText = desc.textContent;
                  desc.textContent =
                    "KYC, ಆದಾಯದ ಪ್ರಮಾಣ ಮತ್ತು ವಾಹನದ ದಾಖಲೆಗಳನ್ನು ಸಾಲದಾತರಿಗೆ ಸಲ್ಲಿಸಿ.";
                }
              }
              if (i === 4) {
                if (strong) {
                  if (!strong.dataset.origText)
                    strong.dataset.origText = strong.textContent;
                  strong.textContent = "ಸಾಲ ಮಂಜೂರು";
                }
                if (desc) {
                  if (!desc.dataset.origText)
                    desc.dataset.origText = desc.textContent;
                  desc.textContent =
                    "ಸಾಮಾನ್ಯವಾಗಿ 24-48 ಗಂಟೆಗಳಲ್ಲಿ ಪಾಲುದಾರ ಸಾಲದಾರರಿಂದ ತ್ವರಿತ ಕ್ರೆಡಿಟ್ ನಿರ್ಧಾರ.";
                }
              }
              if (i === 5) {
                if (strong) {
                  if (!strong.dataset.origText)
                    strong.dataset.origText = strong.textContent;
                  strong.textContent = "ಡಿಸ್ಬರ್ಸಲ್ ಮತ್ತು ವಿತರಣೆ";
                }
                if (desc) {
                  if (!desc.dataset.origText)
                    desc.dataset.origText = desc.textContent;
                  desc.textContent =
                    "ಸಾಲವು ವಿತರಿಸಲ್ಪಟ್ಟಾಗ, ವಾಹನದ ವರ್ಗಾವಣೆ ಮಾಡಿ ಮತ್ತು ನಿಮಗೆ ವಿತರಿಸಲಾಗುತ್ತದೆ.";
                }
              }
            }
            ...
            try {
              ...
              if (hdr && hdr.dataset && hdr.dataset.origText)
                hdr.textContent = hdr.dataset.origText;
              const p = document.querySelector(".finance-hero p");
              if (p && p.dataset && p.dataset.origText)
                p.textContent = p.dataset.origText;
              const ph2 = document.querySelector(".process h2");
              if (ph2 && ph2.dataset && ph2.dataset.origText)
                ph2.textContent = ph2.dataset.origText;
            } catch (e) {}
            for (let i = 1; i <= 5; i++) {
              try {
                const stepEl = document.querySelector(
                  ".process .step:nth-of-type(" + i + ")",
                );
                if (!stepEl) continue;
                const strong = stepEl.querySelector("strong");
                const desc =
                  strong && strong.parentElement
                    ? strong.parentElement.querySelector("div")
                    : null;
                if (strong && strong.dataset && strong.dataset.origText)
                  strong.textContent = strong.dataset.origText;
                if (desc && desc.dataset && desc.dataset.origText)
                  desc.textContent = desc.dataset.origText;
              } catch (e) {}
            }
            ...
            document
              ...
              .forEach(function (img) {
                try {
                  if (img && img.dataset && img.dataset.origAlt !== undefined)
                    img.setAttribute("alt", img.dataset.origAlt);
                } catch (e) {}
              });
